...
# ── Stage 2: Package ────────────────────────────────────────────────────────
VERSION="$(date +%Y%m%d)"
PACKAGE_NAME="chess-game-viewer-${VERSION}"
...
cp viewer/pkg/chess_engine.js           "${PACKAGE_NAME}/pkg/"
cp viewer/pkg/chess_engine_bg.wasm      "${PACKAGE_NAME}/pkg/"
cp viewer/pkg/chess_engine.d.ts         "${PACKAGE_NAME}/pkg/"
cp viewer/pkg/chess_engine_bg.wasm.d.ts "${PACKAGE_NAME}/pkg/"
